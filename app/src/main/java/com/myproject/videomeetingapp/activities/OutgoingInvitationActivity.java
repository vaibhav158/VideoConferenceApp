...
import com.myproject.videomeetingapp.network.ApiClient;
import com.myproject.videomeetingapp.network.ApiService;
...
public class OutgoingInvitationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView imageStopInvitation = findViewById(R.id.imageStopMeeting);
        ...
        try {
            ...
            if (receivers != null && receivers.size() > 0) {
                ...
                for (int i = 0; i < receivers.size(); i++) {
                    ...
                    userNames.append(receivers.get(i).firstName).append(receivers.get(i).lastName).append("\n");
                }
